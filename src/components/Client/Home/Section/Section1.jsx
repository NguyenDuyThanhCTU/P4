      ...
      <div className="w-full h-full relative">
            ...
            <>
              <SwiperSlide>
                <img
                  src={items.image}
                  alt="banner"
                  className="d:h-[50vh] w-full z-0 p:h-[30vh] object-cover"
                />
              </SwiperSlide>
            </>
          ))}
        ...
        <div className="text-white bg-[rgba(0,0,0,0.7)] absolute  d:w-[550px] p:w-[250px] p:right-0 d:right-32  z-10 d:bottom-20 p:bottom-0 d:text-[17px] p:text-[10px]">
          <p className="d:py-6 d:px-5 p:p-2 ">
            Công ty Nông nghiệp sao vàng. Lĩnh vực, ngành nghề chính là: sản
            xuất, kinh doanh các loại phân bón (phân bón lá, phân bón gốc, phân
            hữu cơ, phân vi sinh...); sản xuất, sang chai đóng gói, kinh doanh
            thuốc bảo vệ thực vật; Sản xuất, kinh doanh thức ăn bổ sung, các chế
            phẩm sinh học dùng trong nuôi trồng thủy sản; kinh doanh hóa chất
            thương mại dùng trong nông nghiệp.
          </p>
        </div>
