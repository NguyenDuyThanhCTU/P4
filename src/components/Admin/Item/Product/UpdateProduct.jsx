...
const UpdateProduct = () => {
  ...
  const { setIsUploadProduct, setIsRefetch, updateId } = useStateProvider();
  const { productTypes } = useData();

  useEffect(() => {
    const selectedItem = Products.find((item) => item.id === updateId);
    ...
    if (selectedItem) {
      ...
      setParentTypeName(selectedItem.parentTypeName);
      setParentType(selectedItem.parentType);
      setTypeName(selectedItem.typeName);
